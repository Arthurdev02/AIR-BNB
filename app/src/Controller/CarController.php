...
class CarController extends Controller
{
    ...
    {
        $view = new View( 'car:owner:create' );
    ...
    public function create( ServerRequest $request ): void
    {
        ...
        $this->redirect( '/owner/cars' );
    }

    // owner: Liste
    public function index(): void
    {
        $view = new View( 'car:owner:list' );
    ...
    {
        $view = new View( 'car:owner:details' );
